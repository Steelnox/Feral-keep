...
public class MovableRocks : MonoBehaviour
{
    ...
    public Vector2 CheckSideToPush()
    {
        ...
        float angleBetweenForward = Vector2.Angle(GenericSensUtilities.instance.Transform3DTo2DMovement(GenericSensUtilities.instance.GetDirectionFromTo_N(PlayerController.instance.characterModel.transform.position, rockBody.transform.position)), GenericSensUtilities.instance.Transform3DTo2DMovement(rockBody.transform.forward));
        float angleBetweenRight = Vector2.Angle(GenericSensUtilities.instance.Transform3DTo2DMovement(GenericSensUtilities.instance.GetDirectionFromTo_N(PlayerController.instance.characterModel.transform.position, rockBody.transform.position)), GenericSensUtilities.instance.Transform3DTo2DMovement(rockBody.transform.right));
